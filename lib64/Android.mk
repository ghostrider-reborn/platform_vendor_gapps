...
include $(CLEAR_VARS)
LOCAL_MODULE := liblpmdeviceutils.so
LOCAL_MODULE_CLASS := FAKE
LOCAL_MODULE_TAGS := optional
include $(BUILD_SYSTEM)/base_rules.mk
$(LOCAL_BUILT_MODULE): TARGET := /lib64/liblpmdeviceutils.so
$(LOCAL_BUILT_MODULE): SYMLINK := $(TARGET_OUT)/app/ConnectivityMonitor/lib/arm64/$(LOCAL_MODULE)
$(LOCAL_BUILT_MODULE):
	$(hide) echo "Symlink: $(SYMLINK) -> $(TARGET)"
	$(hide) mkdir -p $(dir $@)
	$(hide) mkdir -p $(dir $(SYMLINK))
